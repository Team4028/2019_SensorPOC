...
public class RobotMap 
{
	...
	public static final int RIGHT_DRIVE_MASTER_CAN_ADDR = 3;//1;
	public static final int RIGHT_DRIVE_SLAVE_CAN_ADDR = 4; //2;
	public static final int LEFT_DRIVE_MASTER_CAN_ADDR = 1; //3;
	public static final int LEFT_DRIVE_SLAVE_CAN_ADDR = 2; //4;
