...
public class RobotMap {
	...
	// DIO Ports
	public static final int CARGO_LIMIT_SWITCH = 0;
	// Analog Ports
	...
	// PCM Ports
	public static final int PCM_FORWARD_BEAK_OPENCLOSE_SOLENOID_PORT = 0;
	public static final int PCM_REVERSE_BEAK_OPENCLOSE_SOLENOID_PORT = 1;
	...
	public static final int PCM_REVERSE_BUCKET_SOLENOID_PORT = 6;
	public static final int PCM_FORWARD_BUCKET_SOLENOID_PORT = 7;
