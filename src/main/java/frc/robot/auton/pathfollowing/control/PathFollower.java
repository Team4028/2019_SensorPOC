package frc.robot.auton.pathfollowing.control;

import frc.robot.Constants;
import frc.robot.auton.pathfollowing.motion.RigidTransform;
import frc.robot.auton.pathfollowing.motion.Twist;
import frc.robot.auton.pathfollowing.motionProfile.MotionProfileConstraints;
import frc.robot.auton.pathfollowing.motionProfile.MotionProfileGoal;
import frc.robot.auton.pathfollowing.motionProfile.MotionProfileGoal.CompletionBehavior;

import edu.wpi.first.wpilibj.Timer;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;

import frc.robot.auton.pathfollowing.motionProfile.MotionState;
import frc.robot.auton.pathfollowing.motionProfile.ProfileFollower;
