package frc.robot.auton.pathfollowing.motion;

import static frc.robot.util.GeneralUtilities.epsilonEquals;

import frc.robot.Constants;
import frc.robot.auton.pathfollowing.util.Interpolable;
